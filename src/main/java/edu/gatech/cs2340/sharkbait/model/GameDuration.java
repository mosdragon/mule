...
public final class GameDuration implements Serializable, Packable {
   ...
   */
    public static void setTurn(final int number) {
        getInstance().turn = number;
    }

  /**
   * Set the players.
   * @param playersField the list of players
   */
  public static void setPlayers(final List<Player> playersField) {
    getInstance().players = playersField;
  }
...
//                End of turn. Sort the list of players
  ...
  /**
   * Ends the turn and handles timer, random events, and production levels.
   */
